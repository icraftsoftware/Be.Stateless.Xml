...
namespace Be.Stateless.Dummies.Xml.Builder
{
	...
	/// to be able to compare them to another recording.
	/// </summary>
	public class XmlReaderSpy : XmlReader
	{
		...
		/// <summary>
		/// All of the invocations that have been performed against the <see cref="XmlReaderSpy"/> since it has been created.
		/// </summary>
